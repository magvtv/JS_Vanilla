 ...
 */
export type Coefficients<ConstraintKey = string> = Iterable<readonly [ConstraintKey, number]> | ([ConstraintKey] extends [string] ? {
    readonly [key in ConstraintKey]?: number;
} : never);
/**
...
export type Model<VariableKey = string, ConstraintKey = string> = {
    ...
    readonly constraints: Iterable<readonly [ConstraintKey, Constraint]> | ([ConstraintKey] extends [string] ? {
        readonly [key in ConstraintKey]?: Constraint;
    } : never);
    /**
    ...
    readonly variables: Iterable<readonly [VariableKey, Coefficients<ConstraintKey>]> | ([VariableKey] extends [string] ? {
        readonly [key in VariableKey]?: Coefficients<ConstraintKey>;
    } : never);
    /**
